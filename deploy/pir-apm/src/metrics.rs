...
memo_http_requests_total{endpoint="metadata",method="GET",status="200"} 90
memo_http_requests_total{endpoint="metadata",method="GET",status="503"} 10
memo_http_request_duration_seconds_bucket{endpoint="metadata",le="0.5"} 60
memo_http_request_duration_seconds_bucket{endpoint="metadata",le="1"} 95
memo_http_request_duration_seconds_bucket{endpoint="metadata",le="+Inf"} 100
memo_http_request_duration_seconds_sum{endpoint="metadata"} 40
memo_http_request_duration_seconds_count{endpoint="metadata"} 100
memo_http_in_flight{endpoint="metadata"} 3
memo_http_request_processing_duration_seconds_bucket{endpoint="query",le="0.5"} 9
memo_http_request_processing_duration_seconds_bucket{endpoint="query",le="+Inf"} 10
memo_http_request_processing_duration_seconds_sum{endpoint="query"} 2
memo_http_request_processing_duration_seconds_count{endpoint="query"} 10
memo_http_processing_in_flight{endpoint="query"} 2
...
"#;
        let parsed = parse_prometheus(&Schema::memo_default(), text, Instant::now()).unwrap();
    ...
    fn missing_processing_family_leaves_processing_unavailable() {
        let parsed = parse_prometheus(
            &Schema::memo_default(),
            r#"
memo_http_requests_total{endpoint="query",method="POST",status="200"} 20
memo_http_request_duration_seconds_bucket{endpoint="query",le="10"} 20
memo_http_request_duration_seconds_bucket{endpoint="query",le="+Inf"} 20
memo_http_request_duration_seconds_sum{endpoint="query"} 180
memo_http_request_duration_seconds_count{endpoint="query"} 20
"#,
            Instant::now(),
        )
        .unwrap();
...
memo_http_requests_total{endpoint="metadata",method="GET",status="200"} 4
memo_snapshot_generation 1
"#,
            Instant::now(),
        )
        .unwrap();
